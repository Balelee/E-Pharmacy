...
class ClientFeedBackResponseView
    extends GetView<ClientFeedBackRequestController> {
  const ClientFeedBackResponseView({super.key});
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Obx(
          () => CustomText(
            text: 'Requette ${controller.requestStatus.value?.label}',
      ...
      body: Obx(
        () => Column(
          children: [
            ...
            //       );
            //     },
            //     child: controller.responses.isEmpty
            //         ? const Center(
            //             key: ValueKey('empty'),
            //             child: CustomText(
            ...
            //               key: const ValueKey('responses'),
            //               padding: const EdgeInsets.all(12),
            //               itemCount: controller.responses.length,
            //               itemBuilder: (context, index) {
            //                 final request = controller.responses[index];
            //                 return Card(
            ...
            //                       children: [
            //                         if (request.status.toLowerCase() != 'expiré')
            //                           Column(
            //                             children: [
            //                               Row(
            //                                 mainAxisAlignment:
            ...
            Expanded(
              child: AnimatedSwitcher(
                ...
                child: PagingListener<int, RequestPharmacy>(
                  controller: controller.pagingController,
                  builder: (context, state, fetchNextPage) {
                    return PagedListView<int, RequestPharmacy>(
                      state: state,
                      fetchNextPage: fetchNextPage,
                      builderDelegate:
                          PagedChildBuilderDelegate<RequestPharmacy>(
