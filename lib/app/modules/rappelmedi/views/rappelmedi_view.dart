              ...
              SizedBox(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    DateTime date = DateTime(controller.currentDate.year,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          CircleAvatar(
                            radius: 22,
                            backgroundColor:
                                index + 1 == controller.currentDate.day
                                    ? AppColors.primary
                                    : Colors.grey.shade300,
                            child: Text(
                              dayNumber,
                              style: TextStyle(
                                color: index + 1 == controller.currentDate.day
                                    ? Colors.white
                                    : Colors.black,
                                fontWeight: FontWeight.bold,
                              ),
                  ...
                  : Column(
                      ...
                      children: [
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            final takeproducts = controller.takeProductS[index];
                            return Container(
